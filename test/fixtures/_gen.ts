...
const numeric: PDFTextContent[] = [
  buildPage([
    { toks: ["Deep", "learning", "has", "advanced", "rapidly", "[1]", "recently."] },
    { toks: ["Several", "architectures", "[3, 5–7]", "have", "been", "proposed."] },
    { toks: ["Comparative", "studies", "[3]", "–", "[5]", "confirm", "these", "results."] },
    { toks: ["Further", "discussion", "appears", "in", "prior", "surveys", "[2]."] },
  ]),
  buildPage([
    { toks: ["References"] },
    { toks: ["[1]", "A. Smith and B. Jones. Deep nets. Journal of ML, 2019."] },
    { toks: ["[2]", "C. Doe. Wide models. In Proc. NeurIPS, 2020. doi:10.1109/5.771073."] },
    { toks: ["[3]", "E. Roe. Attention mechanisms. Trans. AI, 2018."] },
    { toks: ["[4]", "F. Lee. Transformers everywhere. ACM Press, 2021."] },
    { toks: ["[5]", "G. Kim. Scaling laws for models. arXiv preprint, 2020."] },
    { toks: ["[6]", "H. Park. Pretraining strategies. ICML, 2019."] },
    { toks: ["[7]", "I. Cho. Fine-tuning language models. EMNLP, 2020."] },
    { toks: ["[8]", "J. Yun. Knowledge distillation methods. CVPR, 2022."] },
  ]),
];
...
const authorYear: PDFTextContent[] = [
  buildPage([
    { toks: ["Prior", "work", "(Smith et al., 2021)", "established", "the", "method."] },
    { toks: ["Recent", "analysis", "(Gómez and Jones, 2020)", "extends", "it."] },
    { toks: ["As", "shown", "by", "Smith", "et", "al.", "(2021),", "results", "improve."] },
    { toks: ["Two", "efforts", "(Smith, 2020; Jones, 2021)", "diverge", "here."] },
    { toks: ["Earlier", "results", "(Brown, 2020a)", "and", "later", "(Brown, 2020b)", "differ."] },
    { toks: ["We", "also", "note", "(Smith & Jones, 2021)", "and", "(Smith and Jones 2021)."] },
  ]),
  buildPage([
    { toks: ["References"] },
    { toks: ["Brown, A. (2020a). A first study of many things. Journal A."] },
    { toks: ["Brown, A. (2020b). A second study of other things. Journal B."] },
    { toks: ["Gómez, M. and Jones, R. (2020). Extending the method for"] },
    { toks: ["several new application domains. Journal C."], x: ML + 18, eol: true },
    { toks: ["Jones, R. (2021). Divergent efforts in the field. Proc. D."] },
    { toks: ["Smith, J., Doe, K., and Roe, L. (2021). Establishing the"] },
    { toks: ["method with rigorous experiments. ACM Press E."], x: ML + 18, eol: true },
  ]),
];
...
const superscript: PDFTextContent[] = [
  buildPage([
    { toks: ["Recent", "studies", sup("1"), "have", "shown", "significant", "gains."] },
    { toks: ["Other", "work", sup("2,3"), "reports", "similar", "results", "in", "42", "trials."] },
    { toks: ["Follow-up", "analysis", sup("4"), "extends", "this", "line", "of", "work."] },
  ]),
  buildPage([
    { toks: ["References"] },
    { toks: ["[1]", "A. One. A first superscript paper. Journal J, 2019."] },
...
const noReferences: PDFTextContent[] = [
  buildPage([
    { toks: ["The", "theory", "(Smith, 2021)", "is", "well", "studied", "today."] },
    { toks: ["See", "also", "(Jones, 2019)", "for", "additional", "details."] },
  ]),
];
...
const wrap: PDFTextContent[] = [
  buildPage([
    ...
    { toks: ["Background", "(Jones, 2018)", "and", "(Lee, 2019)", "apply", "here."] },
    { toks: ["More", "context", "(Park, 2020)", "is", "also", "relevant."] },
...
function emit(name: string, pages: PDFTextContent[]): void {
  writeFileSync(join(HERE, `${name}.json`), JSON.stringify(pages, null, 2) + "\n", "utf8");
}
