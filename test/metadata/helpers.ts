...
import {
    createHttpClient,
    type HttpClient,
} from "../../src/citations/metadata/throttle";
...
export function calledUrls(fetchMock: {
    mock: { calls: unknown[][] };
}): string[] {
...
export function ref(
    partial: Partial<ResolvedReference> = {}
): ResolvedReference {
    return {
        markerId: "m1",
    ...
    return {
        ...
        locations: [
            ...
            },
            {
                ...
                landing_page_url:
                    "https://journal.example.org/article/1-mirror",
                pdf_url: null,
        ...
        results: [
            {
                ...
                display_name: "Related One",
                publication_year: 2019,
            },
            {
                id: "https://openalex.org/W2002",
                display_name: "Related Two",
